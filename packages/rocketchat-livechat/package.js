...
Package.onUse(function (api) {
  ...
  api.addFiles('client/collections/FAQItems.js', 'client');
  ...
  api.addFiles('client/views/app/tabbar/faqItems.html', 'client');
  api.addFiles('client/views/app/tabbar/faqItems.js', 'client');
  ...
  api.addFiles('server/methods/askQuestion.js', 'server');
  ...
  api.addFiles('server/models/FAQItems.js', ['client', 'server']);
  ...
  api.addFiles('server/publications/faqItems.js', 'server');
